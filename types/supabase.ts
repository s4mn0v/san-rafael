...
export type Database = {
  public: {
    Tables: {
      ...
      animals: {
        Row: { // Datos como vienen de la BD
          id_animal: string
        ...
        Insert: { // Datos necesarios para crear un animal
          ...
          madre_id?: string | null // Opcional
          padre_id?: string | null // Opcional
        }
        Update: { // Datos que se pueden actualizar (todos opcionales)
        ...
        Relationships: [
           {
             foreignKeyName: "fk_animal_madre"
             columns: ["madre_id"]
             referencedRelation: "animals"
             referencedColumns: ["id_animal"]
           },
           {
             foreignKeyName: "fk_animal_padre"
             columns: ["padre_id"]
             referencedRelation: "animals"
             referencedColumns: ["id_animal"]
           }
      ...
      proveedores: { // Definir Proveedores ANTES de Inventario
         Row: {
           id_proveedor: string
